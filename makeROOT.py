...
chlist_str = ["00","01","02","03","04","05","06","07","08","09","10","11","12","13","14","15"]
ch_calib = [203.7,
            190.8,
            192.3,
            201.1,
    ...
    for line in infile:
      ...
      for ch in chlist:
        if ("1  "+chlist_str[ch] in line):
          ...
          ch_lg_calib.push_back(int(line.split()[2])*ch_calib[ch]/calib_mean)
      ...
      if (ch_lg.size()==len(chlist)):
        ...
        ch_lg_calib.clear()
        nevents+=1
        if (nevents%1000==0): print(nevents)
