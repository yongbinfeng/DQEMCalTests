...
fitFunc1 = ROOT.TF1("fitFunc1", myScale, 3.0, 20, 2)
...
DrawHistos([gMean], ["Data Mean"], 0, 35, "Energy [GeV]", 0,
           14e3, "Mean [ADCCount]", "fit_mean", dology=False, drawoptions="P", legendoptions="P", legendPos=[0.45, 0.80, 0.8, 0.85], nMaxDigits=3)

DrawHistos([gSigma, fResol, fBNLResol], ["Data resolution", "Beam #sigma subtracted", "BNL Testbeam Results"], 0, 35, "Energy [GeV]",
           0, 0.15, "#sigma/#mu", "fit_sigma", dology=False, drawoptions=["P", "L", "L"], legendoptions=["P", "L", "L"], legendPos=[0.45, 0.70, 0.8, 0.85])
